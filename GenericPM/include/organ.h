...
protected:
    ...
    int organNumber = 0;
    double newLesions = 0;
    double newLesionsFromOrgan, newLesionsFromPlant, newLesionsFromField;
    double totalLesions = 0;
    double visibleLesions = 0;
    ...
    double dailyTotalLesions = 0;
    double dailyVisibleLesions = 0;
